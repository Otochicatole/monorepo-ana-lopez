...
export interface ApiGalleryTypeGalleryType extends Struct.CollectionTypeSchema {
  collectionName: 'types_of_galleries';
  info: {
    displayName: 'types of galleries';
    pluralName: 'types-of-galleries';
...
export interface ApiGalleryGallery extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    name: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    types_of_gallery: Schema.Attribute.Relation<
      'manyToOne',
      'api::gallery-type.gallery-type'
    >;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiHomeHome extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    imageAbout: Schema.Attribute.Media<'images' | 'files'> &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
